...
export function Hero() {
  ...
  const demos = [
    {
      title: 'React',
      code: `import { StoryCarousel } from '@story-carousel/react';
...
<script setup>
import { StoryCarousel } from '@story-carousel/vue';
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-4">
            Story<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Kit</span>
          </h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200/50">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('features.autoplay.title')}</h3>
            <p className="text-gray-600">{t('features.autoplay.description')}</p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200/50">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('features.progress.title')}</h3>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200/50">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('features.typescript.title')}</h3>
        ...
        <div className="bg-gray-900 rounded-2xl p-8 shadow-2xl max-w-4xl mx-auto">
          ...
          <div className="text-left">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-4 text-gray-400 text-sm">{demos[currentDemo].title}</span>
            </div>
