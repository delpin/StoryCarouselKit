...
StoryCarouselKit — это framework-agnostic компонент для создания списков историй в стиле Instagram. Поддерживает React, Vue, Svelte и Angular с общим type-safe ядром. Включает автопроигрывание, индикаторы прогресса, паузу/удержание, управление NEXT/PREV и настраиваемые темы.
...
- [Рекомендации по разработке](development-guidelines.md)
